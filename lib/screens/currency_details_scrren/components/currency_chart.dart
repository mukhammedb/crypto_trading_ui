...
class CurrencyChart extends StatelessWidget {
  const CurrencyChart({Key? key, required this.priceHistory}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final minPriceRouded = minPrice - (minPrice % interval);
    final List<String> horizontalLines = [];
    for (var v = minPriceRouded; v < maxPrice + interval; v += interval) {
