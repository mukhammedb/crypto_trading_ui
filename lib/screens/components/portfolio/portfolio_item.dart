...
import 'package:crypto_trading_ui/models/currency.dart';
import 'package:crypto_trading_ui/screens/currency_details_scrren/currency_details_screen.dart';
...
class PortfolioItem extends StatelessWidget {
  ...
  const PortfolioItem({Key? key, required this.currency}) : super(key: key);
  ...
  Widget portfolioChart() {
    ...
    return Chart(
        ...
        paddingTop: 72,
        thickness: 2,
        gradientColors: [kSecondaryColor, kSecondaryColor.withOpacity(0)]);
  }
